...
public class MoveStrikeZoneSplash170 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (currentLook == PlayerMovement.Facing.DOWN)
        {
            ...
            splash.rotation = Quaternion.Euler(0, 0, -90);
        }
